...
public abstract class RMBUtil {
	...
	/**
	 * 人民币转换为大写,格式为：~万~千~百~十~元~角~分
	 * 
	 * @author Lucifer Wong
	 * @param numberOfMoney
	 *            传入的金额
	 * @return 人民币转换为大写,格式为：~万~千~百~十~元~角~分
	 */
	public static String number2RMB(String numberOfMoney) {
		return number2RMB(new BigDecimal(numberOfMoney), "");
	}
	 ...
	 * @return 人民币转换为大写,格式为：~万~千~百~十~元~角~分
	 */
	public static String number2RMB(BigDecimal numberOfMoney, String defaultValue) {
	 ...
	 * @param money
	 *            待转换的金额
	 * @return 将人民币转换为会计格式金额(xxxx,xxxx,xxxx.xx),保留两位小数
	 */
	 ...
	 * @return 格式化金额，显示为xxx万元，xxx百万,xxx亿
	 */
	 ...
	 * @param divisor
	 *            格式化值（10:十元、100:百元,1000千元，10000万元......）
	 * @return 获取会计格式的人民币(格式为:xxxx,xxxx,xxxx.xx)
	 */
	 ...
	 * @param divisor
	 *            格式化值
	 * @return 将人民币转换为会计格式金额(xxxx,xxxx,xxxx.xx)
	 */
